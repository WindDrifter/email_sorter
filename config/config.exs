...
config :email_sorter, EmailSorterWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: EmailSorterWeb.ErrorHTML, json: EmailSorterWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: EmailSorter.PubSub,
  live_view: [signing_salt: "H3ejpp6s"]
...
config :email_sorter, EmailSorter.Mailer, adapter: Swoosh.Adapters.Local
